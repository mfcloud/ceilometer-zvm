...
class ZVMInspector(virt_inspector.Inspector):
    ...
    def inspect_cpus(self, instance):
        ...
        try:
            cpu_data = self._sdkapi.guest_inspect_cpus(inst_name)
        ...
        cpu_number = cpu_data[index_key]['guest_cpus']
        used_cpu_time = (
            cpu_data[index_key]['used_cpu_time_us'] * units.k)
